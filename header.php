...
// שמירת user_code ב-SESSION אם לא קיים כבר
if (!isset($_SESSION['user_code']) && !empty($username)) {
...
<!-- 
    הסגנון מוגדר עם דיריקטיבות !important בכל מקום כדי להבטיח שסגנון זה
    לא יידרס על ידי סגנונות אחרים באתר
-->
<style>
    ...
    /* מיכל הכותרת הראשי - fixed בחזרה לראש הדף */
    .doggy-header-container {
...
<div class="doggy-header-container">
    ...
    <div class="doggy-header-top">
        ...
        <div class="doggy-header-user-info">
            ...
            <a href="../logout.php" class="doggy-header-logout">
                <span>התנתקות</span>
